...
class FrontEnd:
    ...
    def menu_initialisation(self):
        self.master.geometry('950x550+250+10')
        self.master.title('Image Editor App with Tkinter and OpenCV')

#Header*****************************************************************************************************************
        self.frame_header = ttk.Frame(self.master)
        self.frame_header.pack()
        ttk.Label(self.frame_header, text="Welcome to the Image Editor App!").grid(row=0, column=0)
...
#Body*******************************************************************************************************************
        ...
        self.frame_body.config(relief=RIDGE, padding=(10, 10))
        self.canvas = Canvas(self.frame_body, bg="gray", width=925, height=400)
...
#Menu*******************************************************************************************************************
        ...
        self.frame_menu.config(relief=RIDGE, padding=(5,5))
        ttk.Button(self.frame_menu, text="Upload An Image", command=self.upload_action).grid(row=0, column=0, padx=5, pady=5, sticky='sw')
        ttk.Button(self.frame_menu, text="Crop Image", command=self.crop_action).grid(row=0, column=5, padx=5, pady=5, sticky='sw')
        ttk.Button(self.frame_menu, text="Add Text", command=self.text_action_1).grid(row=0, column=6, padx=5, pady=5, sticky='sw')
        ttk.Button(self.frame_menu, text="Draw Over Image", command=self.draw_action).grid(row=0, column=2, padx=5, pady=5, sticky='sw')
        ttk.Button(self.frame_menu, text="Apply Filters", command=self.filter_action).grid(row=0, column=3, padx=5, pady=5, sticky='sw')
        ttk.Button(self.frame_menu, text="Blur/Smoothening", command=self.blur_action).grid(row=0, column=1, padx=5, pady=5, sticky='sw')
        ttk.Button(self.frame_menu, text="Adjust Levels", command=self.adjust_action).grid(row=0, column=4, padx=5, pady=5, sticky='sw')
        ttk.Button(self.frame_menu, text="Rotate", command=self.rotate_action).grid(row=0, column=7, padx=5, pady=5, sticky='sw')
        ttk.Button(self.frame_menu, text="Flip", command=self.flip_action).grid(row=0, column=8, padx=5, pady=5, sticky='sw')
        ttk.Button(self.frame_menu, text="Save As", command=self.save_action).grid(row=0, column=9, padx=5, pady=5, sticky='sw')
#Menu-End***************************************************************************************************************
...
#Footer-Menu************************************************************************************************************
        ...
        self.apply.grid(row=0, column=2, padx=5, pady=5, sticky='sw')
        ttk.Button(self.apply_and_cancel, text="Cancel", command=self.cancel_action).grid(row=0, column=1, padx=5, pady=5, sticky='sw')
        ttk.Button(self.apply_and_cancel, text="Revert All Changes", command=self.revert_action).grid(row=0, column=0, padx=5, pady=5, sticky='sw')
#Footer-Menu-End********************************************************************************************************
...
#Filter Menu Options****************************************************************************************************
    def refresh_side_frame(self):
        ...
        self.display_image(self.edited_image)
        self.side_frame = ttk.Frame(self.frame_body)
